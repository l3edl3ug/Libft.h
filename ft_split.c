...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/07 12:42:26 by tphoonsi          #+#    #+#             */
/*   Updated: 2024/09/07 12:42:27 by tphoonsi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ที่ต้องfreearray เพราะว่า
ปลดปล่อยหน่วยความจำของสตริงแต่ละตัวฟังก์ชัน ft_substr 
จัดสรรหน่วยความจำสำหรับแต่ละสตริงที่แยกออกมา
ถ้าฟังก์ชัน ft_substr ล้มเหลวในการจัดสรรหน่วยความจำหรือเกิดข้อผิดพลาด
ต้องปลดปล่อยหน่วยความจำที่จัดสรรไว้แล้วเพื่อหลีกเลี่ยงการรั่วไหลของหน่วยความจำ
aka.memory leak
*/
